...
type IsHasPermissionsRequest struct {
...
func (x *IsHasPermissionsRequest) Reset() {
	*x = IsHasPermissionsRequest{}
...
func (x *IsHasPermissionsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsHasPermissionsRequest) ProtoMessage() {}

func (x *IsHasPermissionsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_auth_service_proto_msgTypes[0]
...
// Deprecated: Use IsHasPermissionsRequest.ProtoReflect.Descriptor instead.
func (*IsHasPermissionsRequest) Descriptor() ([]byte, []int) {
	return file_auth_service_proto_rawDescGZIP(), []int{0}
}

func (x *IsHasPermissionsRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *IsHasPermissionsRequest) GetPermissions() []string {
	if x != nil {
...
type IsHasPermissionsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *IsHasPermissionsResponse) Reset() {
	*x = IsHasPermissionsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *IsHasPermissionsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsHasPermissionsResponse) ProtoMessage() {}

func (x *IsHasPermissionsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_auth_service_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsHasPermissionsResponse.ProtoReflect.Descriptor instead.
func (*IsHasPermissionsResponse) Descriptor() ([]byte, []int) {
	return file_auth_service_proto_rawDescGZIP(), []int{1}
}

func (x *IsHasPermissionsResponse) GetApproved() bool {
	if x != nil {
		return x.Approved
	}
	return false
...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x54, 0x0a, 0x17, 0x49, 0x73,
	...
	0x22, 0x36, 0x0a, 0x18, 0x49, 0x73, 0x48, 0x61, 0x73, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73,
	...
	0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x64, 0x22, 0x43, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69,
	...
	0x6d, 0x69, 0x6e, 0x32, 0xfe, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x51, 0x0a, 0x10,
	0x49, 0x73, 0x48, 0x61, 0x73, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73,
	0x12, 0x1d, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x49, 0x73, 0x48, 0x61, 0x73, 0x50, 0x65, 0x72,
	0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x1e, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x49, 0x73, 0x48, 0x61, 0x73, 0x50, 0x65, 0x72, 0x6d,
	...
	0x6f, 0x6d, 0x2f, 0x41, 0x72, 0x65, 0x6e, 0x44, 0x6a, 0x61, 0x6e, 0x67, 0x6f, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x73, 0x62,
...
var file_auth_service_proto_goTypes = []interface{}{
	(*IsHasPermissionsRequest)(nil),  // 0: auth.IsHasPermissionsRequest
	(*IsHasPermissionsResponse)(nil), // 1: auth.IsHasPermissionsResponse
...
var file_auth_service_proto_depIdxs = []int32{
	0, // 0: auth.Auth.IsHasPermissions:input_type -> auth.IsHasPermissionsRequest
	6, // 1: auth.Auth.IsAdmin:input_type -> auth.IsAdminRequest
	4, // 2: auth.Auth.Login:input_type -> auth.LoginRequest
	2, // 3: auth.Auth.Register:input_type -> auth.RegisterRequest
	1, // 4: auth.Auth.IsHasPermissions:output_type -> auth.IsHasPermissionsResponse
	7, // 5: auth.Auth.IsAdmin:output_type -> auth.IsAdminResponse
...
func file_auth_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_auth_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IsHasPermissionsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_auth_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IsHasPermissionsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
